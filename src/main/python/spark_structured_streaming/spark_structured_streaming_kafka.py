...
if __name__ == "__main__":
    print_info("PySpark Structured Streaming with Kafka Demo Application Started ...")
    ...
    spark = SparkSession \
        ...
        .master("local[*]") \
        .config("spark.jars",
                "file:///opt/spark/2.4.3/jars/spark-sql-kafka-0-10_2.11-2.4.3.jar,file:///opt/spark/2.4.3/jars/kafka-clients-2.2.0.jar") \
    ...
    print_warn("Printing Schema of transaction_detail_df: ")
    ...
    print_info("Printing Schema of transaction_detail_df4: ")
    ...
    print_warn("Printing Schema of transaction_detail_df5: ")
    ...
    trans_detail_write_stream_1 = transaction_detail_df5 \
        ...
        .trigger(processingTime='1 seconds') \
        .outputMode("update") \
        .option("checkpointLocation", "file:///home/rameshbabug/Documents/Tutorials/"
                                      "Output/spark/spark_structured_streaming/checkpoint/") \
        .start()

    trans_detail_write_stream.awaitTermination()

    print_warn("PySpark Structured Streaming with Kafka Demo Application Completed.")
